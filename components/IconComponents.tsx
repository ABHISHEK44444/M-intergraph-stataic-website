...
export const MIntergraphLogo: React.FC<IconProps> = (props) => (
    <svg viewBox="0 0 52 42" xmlns="http://www.w3.org/2000/svg" {...props}>
        <g transform="skewX(-15)">
            <rect x="0" y="0" width="12" height="42" fill="#facc15" />
            <rect x="13" y="0" width="12" height="42" fill="#4ade80" />
            <rect x="26" y="0" width="12" height="42" fill="#22d3ee" />
            <rect x="39" y="0" width="12" height="42" fill="#3b82f6" />
        </g>
    </svg>
);
